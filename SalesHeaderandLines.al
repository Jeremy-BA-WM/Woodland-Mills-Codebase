query 80010 "API - Sales Return Hdr+Line"
{
    QueryType = API;
    ...
    EntityName = 'SalesHeaderandLines';     // singular
    EntitySetName = 'SalesHeaderandLines';    // plural
    ...
    elements
    {
        dataitem(SalesHeader; "Sales Header")
        {
            ...
            column(HeaderShipmentMethodCode; "Shipment Method Code") { }
            ...
            column(HeaderReleasedStatus; "WSI Released Status") { }
            column(HeaderWSIStatus; "WSI Status") { }
            column(HeaderFulfillabilityStatus; "WSI Fulfillability Status") { }
            ...
            dataitem(SalesLine; "Sales Line")
            {
                ...
                // DataItemLinkType = InnerJoin; // Removed, not supported in API queries
                ...
                column(LineReservedQTY; "Reserved Quantity") { }
